...
//function to initialize USART0 to "int" Baud, 8 data bits,no parity, and 
//one stop bit. Assume FCPU = 16MHz
...
//Wait for USART0 (myUCSR0A) TBE to be set then write character to transmit
//buffer
